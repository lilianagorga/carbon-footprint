...
import EmissionsPresentational from '../components/EmissionsList/EmissionsPresentational';
import { sortAndFormatData, filterDataByDateRange } from '../utils';

const EmissionsContainer = () => {
  ...
  useEffect(() => {
    ...
    return (
      <EmissionsPresentational rangeEmissions={rangeEmissions} average={average} />
    );
  };
