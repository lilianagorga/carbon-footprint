...
import imageNasa1 from '../assets/img-nasa-1.jpeg';
import imageNasa2 from '../assets/img-nasa-2.jpeg';
import imageNasa3 from '../assets/img-nasa-3.jpeg';
import videoNasa1 from '../assets/video-nasa-1.mp4';

const About = () => {
  return (
    <div>
      <h1>Welcome to Carbon Footprint</h1>
      <h2>Who We Are</h2>
      <p>
        Welcome to Carbon Footprint, your resource for calculating CO2 emissions and environmental impact. We're passionate about the environment and want to help you understand the significance of your actions on our planet's health.
      </p>
      ...
      <h2>Images</h2>
        <img src={imageNasa1} alt="" />
        <img src={imageNasa2} alt="" />
        <img src={imageNasa3} alt="" />
      <video controls>
